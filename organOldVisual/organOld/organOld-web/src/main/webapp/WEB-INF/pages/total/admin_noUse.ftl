<style>
    ...
    <div class="row">
        <div class="col-lg-4" style="position: relative;left: 6.5%;">
            ...
            <div class="row" style="margin-top: 2%;">
                ...
                <div class="col-lg-4 tu2" style="margin-left: 3.2%;background-color: #607d8b">
                    <p class="num_p">涉老机构数量</p>
                    <p class="num">${num.organNum!0}</p>
                </div>
            </div>
            <script>
        ...
        <div class="col-lg-8" style="position: relative;left: 9%">
            <div class="row">
                <div class="col-lg-4 tu" style="width: 37%">z
                    <div id="old" class="tuPie" onclick="back('/oldman',1)"></div>
                </div>
                <div class="col-lg-4 tu" style="position:relative;left:3%;width: 37%">
                    <div id="organ" class="tuPie" onclick="$('#organModal').modal();"></div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        if(winWidth>=1700){
            ...
            tuPie_h=winHeight/3.5;
            tuBar_w=winWidth/4.2;
            tuBar_h=winHeight/3.3;
...
//                titleClick.link="javascript:newPage(1,'重点老人','/oldman/key')";
        ...
        ////                title_text="养老状态";
        //                title_text="养老信息";
        ////                titleClick.link="javascript:oldStatus()";
        //                legend_data=[{name:'机构'},{name:'社区居家'},{name:'社区+居家'},{name:'社区'},{name:'居家'}];
        //                series=[
        //                    {
        //                        name:'',
        //                        type:'pie',
        ...
        //                        },
        //                        data:[
        //                            {value:dataR.organOldNum, name:'机构'},
        //                            {value:dataR.communityOldNum+dataR.familyOldNum+dataR.cfOldNum, name:'社区居家', selected:true}
        //                        ]
        //                    },
        //                    {
        //                        name:'',
        ...
        //                        },
        //                        data:[
        //                            {value:dataR.communityOldNum, name:'社区'},
        //                            {value:dataR.familyOldNum, name:'居家'},
        //                            {value:dataR.cfOldNum, name:'社区+居家'}
        //                        ]
        //                    }
        //                ];
        //                tooltip = {
        ...
        $.ajax({
            ...
            success : function(data) {
                if (data.success==true) {
                    ...
                    var option_organ = chartPie(title_text,legend_data,series,tooltip);
